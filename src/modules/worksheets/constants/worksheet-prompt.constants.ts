      ...
      ? [
          ...
          ...(toddlerOrUnder4
            ? [
                ...
                '  • Activity count: choose **1 or 2** activity sections (plus the instruction box). NEVER 3+. Prefer 1 big clear activity when that keeps pictures large; use 2 only when both stay easy and readable.',
                ...
                '  • IMAGE SIZE: decide dynamically — fill most of each section with recognizable art (typically 140–180px boxes). Never leave a big empty section with tiny icons. Prefer fewer images over tiny images.',
