  ...
  return [
    ...
    ...(isUniversal
      ? [
          ...
          '  • Prefer 2–3 activity sections (rarely 4). If a section needs 3 match rows, image boxes MUST be ≤72–80px. Prefer 2 match pairs when boxes are ≥90px.',
          ...
          '  • Colour/trace or multi-card sets: 4 cards → 2×2 grid; 6 cards → 2×3 or 3×2. Only emit images that fit on THIS page.',
          '',
          ...
          '  • Match with blue dots between columns (space for drawn lines) — max 3 pairs with small boxes',
